      ...
      {songs && songs.map((el) => (
        ...
        >
          <div className="mb-4 relative flex justify-center items-center">
            ...
            />
            <button className="p-3 text-3xl bg-main-green rounded-full text-gray absolute right-4 bottom-4 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0 ease-out bg-[#65D46E] text-black" onClick={setSong(el)}>
              <RiPlayFill />
            </button>
          </div>
          <div>
